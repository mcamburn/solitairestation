...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "16 free solitaire games playable instantly in your browser — no download or sign-up needed. Klondike, Spider, FreeCell, Mahjong, Golf, Forty Thieves, Yukon, and 9 more. Works on any device." },
      ...
      { name: "twitter:description", content: "16 free solitaire games — play Klondike, Spider, FreeCell, Mahjong, Golf, Forty Thieves, Yukon, and more instantly. No download or sign-up needed." },
  ...
  "@graph": [
    {
      ...
      "description": "Solitaire Station — play 16 free solitaire games instantly in your browser. Klondike, Spider, FreeCell, Pyramid, TriPeaks, Mahjong, Golf, Forty Thieves, Yukon, Scorpion, Eight Off, Canfield, Baker's Dozen, Baker's Game, Clock, and Addiction. No download or sign-up required.",
