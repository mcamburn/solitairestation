...
export const Route = createFileRoute("/freecell")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Solitaire Station — Free FreeCell Solitaire" },
      ...
      { property: "og:image", content: `${SITE_URL}/og/freecell.png?v=5` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Solitaire Station — Free FreeCell Solitaire" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Solitaire Station — Free FreeCell Solitaire" },
      ...
      { name: "twitter:image", content: `${SITE_URL}/og/freecell.png?v=5` },
    ],
    links: [
...
const FREECELL_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Solitaire Station — Free FreeCell Solitaire",
