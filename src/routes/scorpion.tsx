...
export const Route = createFileRoute("/scorpion")({
  head: () => ({
    meta: [
      { title: "Free Scorpion Solitaire — Solitaire Station" },
      ...
      { property: "og:title", content: "Free Scorpion Solitaire — Solitaire Station" },
      ...
      { property: "og:image", content: `${SITE_URL}/og/scorpion.png` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Free Scorpion Solitaire — Solitaire Station" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Free Scorpion Solitaire — Solitaire Station" },
      ...
      { name: "twitter:image", content: `${SITE_URL}/og/scorpion.png` },
    ],
    links: [
...
const SCORPION_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Free Scorpion Solitaire — Solitaire Station",
