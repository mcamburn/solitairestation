...
export const Route = createFileRoute("/addiction")({
  head: () => ({
    meta: [
      { title: "Free Addiction Solitaire — Solitaire Station" },
      { name: "description", content: "Play free Addiction solitaire online — arrange cards in same-suit rows from 2 to King using gaps. Up to 3 reshuffles allowed. No download or sign-up." },
      { name: "robots", content: "index, follow" },
      { property: "og:site_name", content: "Solitaire Station" },
      { property: "og:locale", content: "en_US" },
      { property: "og:title", content: "Free Addiction Solitaire — Solitaire Station" },
      ...
      { property: "og:image", content: `${SITE_URL}/og/addiction.png` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Free Addiction Solitaire — Solitaire Station" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Free Addiction Solitaire — Solitaire Station" },
      ...
      { name: "twitter:image", content: `${SITE_URL}/og/addiction.png` },
    ],
    links: [
...
const ADDICTION_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Free Addiction Solitaire — Solitaire Station",
