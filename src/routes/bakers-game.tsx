...
export const Route = createFileRoute("/bakers-game")({
  head: () => ({
    meta: [
      { title: "Free Baker's Game Solitaire — Solitaire Station" },
      ...
      { property: "og:title", content: "Free Baker's Game Solitaire — Solitaire Station" },
      ...
      { property: "og:image:alt", content: "Free Baker's Game Solitaire — Solitaire Station" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Free Baker's Game Solitaire — Solitaire Station" },
...
const BAKERSGAME_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Free Baker's Game Solitaire — Solitaire Station",
