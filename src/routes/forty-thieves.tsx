...
export const Route = createFileRoute("/forty-thieves")({
  head: () => ({
    meta: [
      { title: "Free Forty Thieves Solitaire — Solitaire Station" },
      { name: "description", content: "Play free Forty Thieves solitaire online — a challenging two-deck game with 10 tableau columns and 8 foundations. No download or sign-up required." },
      { name: "robots", content: "index, follow" },
      { property: "og:site_name", content: "Solitaire Station" },
      { property: "og:locale", content: "en_US" },
      { property: "og:title", content: "Free Forty Thieves Solitaire — Solitaire Station" },
      ...
      { property: "og:image", content: `${SITE_URL}/og/forty-thieves.png` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Free Forty Thieves Solitaire — Solitaire Station" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Free Forty Thieves Solitaire — Solitaire Station" },
      ...
      { name: "twitter:image", content: `${SITE_URL}/og/forty-thieves.png` },
    ],
    links: [
...
const FORTY_THIEVES_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Free Forty Thieves Solitaire — Solitaire Station",
