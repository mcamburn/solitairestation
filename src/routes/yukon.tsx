...
export const Route = createFileRoute("/yukon")({
  head: () => ({
    meta: [
      { title: "Free Yukon Solitaire — Solitaire Station" },
      ...
      { property: "og:title", content: "Free Yukon Solitaire — Solitaire Station" },
      ...
      { property: "og:image", content: `${SITE_URL}/og/yukon.png` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Free Yukon Solitaire — Solitaire Station" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Free Yukon Solitaire — Solitaire Station" },
      ...
      { name: "twitter:image", content: `${SITE_URL}/og/yukon.png` },
    ],
    links: [
...
const YUKON_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Free Yukon Solitaire — Solitaire Station",
  "url": `${SITE_URL}/yukon`,
