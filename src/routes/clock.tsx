...
export const Route = createFileRoute("/clock")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Solitaire Station — Free Clock Patience" },
      ...
      { property: "og:image", content: `${SITE_URL}/og/clock.png?v=5` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Solitaire Station — Free Clock Patience" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Solitaire Station — Free Clock Patience" },
      ...
      { name: "twitter:image", content: `${SITE_URL}/og/clock.png?v=5` },
    ],
    links: [
...
const CLOCK_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Solitaire Station — Free Clock Patience",
  "url": `${SITE_URL}/clock`,
