    ...
    <main className="mx-auto min-h-screen w-full max-w-[760px] px-4 py-10 sm:py-16">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <Section n="1" title="Acceptance of Terms">
          <p>These Terms of Use ("Terms") describes the terms of service applicable for your access and/or use of our website located at https://www.solitairestation.com and any services offered or provided by Solitaire Station ("Company", or "we", "our" or "us") through the website located at https://www.solitairestation.com or otherwise provided by us, including but not limited to the providing a solitaire game for you to play, all other services that may be made available by us, and the content on the website (the "Site"). We own and operate the Site.</p>
