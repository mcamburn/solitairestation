...
export const Route = createFileRoute("/eight-off")({
  head: () => ({
    meta: [
      { title: "Free Eight Off Solitaire — Solitaire Station" },
      ...
      { property: "og:title", content: "Free Eight Off Solitaire — Solitaire Station" },
      ...
      { property: "og:image:alt", content: "Free Eight Off Solitaire — Solitaire Station" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Free Eight Off Solitaire — Solitaire Station" },
...
const EIGHTOFF_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Free Eight Off Solitaire — Solitaire Station",
