...
export const Route = createFileRoute("/golf")({
  head: () => ({
    meta: [
      { title: "Solitaire Station — Free Golf Solitaire" },
      ...
      { property: "og:title", content: "Solitaire Station — Free Golf Solitaire" },
      ...
      { property: "og:image", content: `${SITE_URL}/og/golf.png?v=6` },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Solitaire Station — Free Golf Solitaire" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Solitaire Station — Free Golf Solitaire" },
      ...
      { name: "twitter:image", content: `${SITE_URL}/og/golf.png?v=6` },
    ],
    links: [
...
const GOLF_LD = JSON.stringify({
  ...
  "@type": "WebApplication",
  "name": "Solitaire Station — Free Golf Solitaire",
  "url": `${SITE_URL}/golf`,
