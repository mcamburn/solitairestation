...
export function BakersDozn() {
  ...
  return (
    ...
    >
      ...
      {/* Tableau */}
      <div className="game-board-glass glass mt-3 overflow-x-auto rounded-2xl p-3 sm:p-4" style={{ touchAction: dragMode ? "none" : "pan-x" }}>
        <div ref={boardRef}>
      ...
      {game.won && (
        <DailyWinBanner message={`Baker's Dozen solved in ${game.moves} moves!`} onNew={reset} stats={gameStats} />
      )}
