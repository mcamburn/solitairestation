...
export function AppearanceBar({
  ...
  const triggerBase =
    "w-full h-full flex items-center gap-2 px-4 py-3.5 text-left transition-colors hover:bg-secondary/40 rounded-none focus-visible:outline-none focus-visible:bg-secondary/40";
